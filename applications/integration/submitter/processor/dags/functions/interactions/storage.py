...
def storage_object_interaction(
    ...
    if data_type in valid_types:
        ...
        if data_type == valid_types[0]:
            ...
            object_stored = storage_orchestration_interaction(
        ...
        if data_type == valid_types[1]:
            ...
            object_stored = storage_logs_interaction(
                swift_client = swift_client,
                bucket_parameters = bucket_parameters,
                storage_parameters = storage_parameters
            )
        if data_type == valid_types[2]:
            ...
            object_stored = storage_metrics_interaction(
                swift_client = swift_client,
                bucket_parameters = bucket_parameters,
                storage_parameters = storage_parameters
            )
