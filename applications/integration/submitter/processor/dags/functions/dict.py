...
def update_nested_dict(
    ...
    # memory addressses
    # This cannot handle time nesting right now, because it
    # assumes we have access to the old information
    # and that changes in previous information is not minded
