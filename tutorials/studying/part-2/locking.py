from redis_func.setup import redis_client_check, redis_setup_instance
from redis_func.use import redis_lock_interaction, redis_lock_checking, redis_name_lock
...
def concurrency_check_lock(
    ...
    print('Lock named ' + str(lock_name) + ' active: ' + str(lock_active))
