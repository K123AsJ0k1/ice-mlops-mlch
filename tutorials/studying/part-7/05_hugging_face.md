...
3. <span id="used-material-3"></span> [Hugging Face datasets](https://huggingface.co/datasets)
...
9. <span id="used-material-9"></span> [Hugging Face models](https://huggingface.co/models)
...
These features make Hugging Face the default dataset and model hub for our local-cloud-HPC workflows. We will use it to get external datasets for general evaluation and load models to be run via suitable inference frameworks. 

## How to use Hugging Face?

Assuming you have already created a Hugging Face account, begin by creating a user access token [(1)](#used-material-1) with the following fine-grained custom permissions: read contents of your repos, read contents of public gated repos you can access, and read your collections. Put the token into your $USER/.ssh/.env file with the key HF_TOKEN to enable loading it with:
